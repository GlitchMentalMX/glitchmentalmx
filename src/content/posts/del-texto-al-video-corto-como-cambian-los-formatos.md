...
![Del texto al video corto: pila de periódicos con barras ascendentes que emergen como datos digitales](/images/posts/del-texto-al-video-corto-como-cambian-los-formatos/1.png)
...
[→ Por qué todo el contenido se vuelve más corto y más rápido](/articulos/por-que-todo-el-contenido-se-vuelve-mas-corto-y-mas-rapido/) [→ Cuando la vida entera se convierte en contenido](/articulos/cuando-la-vida-entera-se-convierte-en-contenido/) [→ El fin de lo "viral" como fenómeno orgánico](/articulos/el-fin-de-lo-viral-como-fenomeno-organico/)
