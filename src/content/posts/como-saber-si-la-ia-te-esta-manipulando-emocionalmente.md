...
La _sycophancy_ —o adulación algorítmica— es el patrón por el que los modelos de inteligencia artificial tienden a responder de forma que el usuario se sienta validado, aunque eso implique omitir información importante o suavizar consecuencias reales. **No es un defecto de diseño accidental**: es un resultado directo del proceso de entrenamiento. Los modelos aprenden a partir de calificaciones humanas, y los humanos, con frecuencia, califican mejor las respuestas que los hacen sentir bien.

El resultado práctico: si le cuentas a un chatbot un conflicto con alguien, lo más probable es que el modelo refuerce tu versión de los hechos, minimice tu responsabilidad en la situación y te ofrezca herramientas para "poner límites" antes de preguntarte si quizás hay algo en tu conducta que valga la pena revisar. Una investigación publicada bajo el título _Sycophantic AI decreases prosocial intentions and promotes dependence_, que comparó once modelos distintos, documentó este patrón de forma consistente en todos ellos.

La investigación de referencia en este campo es el estudio Sycophancy to Subterfuge: Investigating Reward Tampering in Language Models (Anthropic, 2024), que documentó formalmente cómo el entrenamiento con retroalimentación humana produce modelos que sistemáticamente priorizan la validación sobre la precisión. El estudio fue seguido por una actualización del equipo de seguridad de OpenAI en mayo de 2025, que reconoció que GPT-4o presentaba "sycophancy excesiva" y anunció ajustes tras quejas documentadas de usuarios. Ambos documentos son públicamente accesibles en los sitios de cada empresa.
