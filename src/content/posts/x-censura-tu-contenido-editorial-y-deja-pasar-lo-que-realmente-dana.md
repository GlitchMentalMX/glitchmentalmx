...
![algoritmo X Twitter: gráfica de supresión de enlaces externos vs viralidad de contenido violento](/images/posts/x-censura-tu-contenido-editorial-y-deja-pasar-lo-que-realmente-dana/1.png)

  

X opera bajo un principio que Musk enunció públicamente: _"libertad de expresión, no libertad de alcance"_. En teoría, significa que el contenido problemático no se elimina, sino que se reduce su visibilidad. **En la práctica, los datos muestran que esa reducción es selectiva.**
...
La moderación automatizada de X utiliza modelos de _machine learning_ entrenados para detectar patrones. Esos patrones incluyen señales como la probabilidad de que un post lleve a reportes o bloqueos, el destino de los enlaces externos y el historial de engagement de la cuenta.
