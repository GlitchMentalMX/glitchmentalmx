...
La diferencia con el caso alemán no es solo el resultado — es **qué se demandó**. GEMA no objetó que el modelo "aprendiera" de las canciones en abstracto. Objetó que el modelo pudiera _reproducirlas_ palabra por palabra a quien preguntara. Esa distinción —entre absorber un estilo y poder regurgitar la obra exacta— es probablemente la línea sobre la que se va a construir buena parte de la regulación que viene.
