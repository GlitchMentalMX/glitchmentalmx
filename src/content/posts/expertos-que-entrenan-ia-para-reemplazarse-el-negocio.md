...
**Lo que sí es un hecho verificable**: el sector de _reinforcement learning_ por expertos humanos ya mueve miles de millones de dólares, y los grandes laboratorios de IA lo necesitan para que sus modelos funcionen. El trabajo existe, paga bien y está creciendo. La pregunta de si eso es una solución o una etapa de transición hacia algo más difícil de predecir sigue abierta.
