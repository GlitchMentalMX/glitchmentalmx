...
![Biometría de voz: mano con celular junto a onda de audio bifurcada, verificación bancaria clonada en primer plano](/images/uploads/biometria-de-voz-sec.webp)
...
Nada de esto es exclusivo de la banca. [La misma industria que automatiza el fraude en granjas de trata también automatiza las llamadas de suplantación de voz](https://glitchmental.com/articulos/granja-cerdos-digital-trata-fraude/): la infraestructura de call centers forzados y la infraestructura de vishing (estafa de phishing realizada mediante llamadas de voz) con voz clonada no son sistemas separados, comparten proveedores, guiones y a veces hasta las mismas víctimas. Ese artículo de esta serie documenta la cadena de producción del lado del fraude organizado; este documenta la cadena de negación del lado institucional. [El fraude de extorsión familiar con voz clonada](https://glitchmental.com/articulos/clonacion-de-voz-por-ia-se-incrementa-en-mexico/) que ya se cubrió en este sitio describe la mecánica individual de esa misma vulnerabilidad — la versión que le pasa a una familia por teléfono, no a un banco por ventanilla.
