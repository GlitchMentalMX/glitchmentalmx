---
title: Meta elimina verificadores externos y ahora usa "notas de comunidad" como X
...
---
Meta anunció el 7 de enero que eliminará el programa de verificadores de hechos externos en Facebook e Instagram. **En su lugar, implementará un sistema de "notas de comunidad" similar al que usa X (anteriormente Twitter)**. [Mark Zuckerberg](https://es.wikipedia.org/wiki/Mark_Zuckerberg) dijo que el cambio es para promover la "libertad de expresión" y reducir la "censura" percibida. Los críticos dicen que es abandono de responsabilidad corporativa sobre la desinformación.
