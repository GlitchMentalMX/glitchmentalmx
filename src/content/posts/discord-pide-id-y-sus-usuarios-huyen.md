...
![Redes sociales 2026: mujer interactuando con mensajes digitales fragmentados en pantalla](/images/posts/discord-pide-id-y-sus-usuarios-huyen/1.png)

  

Matthew Hodgson, cofundador técnico y CEO de Matrix, confirmó en el blog oficial de la plataforma que el incremento de usuarios era real y atribuible al anuncio de Discord. Matrix es una plataforma de mensajería descentralizada de código abierto: los usuarios pueden unirse a servidores existentes o crear los propios bajo gobernanza independiente. Su diseño apela a quienes desconfían del control centralizado de datos.

Sin embargo, Hodgson fue explícito en un punto clave: Matrix tampoco es un paraíso sin reglas. Matrix.org implementó una política de mayores de 18 años desde el verano pasado para cumplir con el mismo _UK Online Safety Act_ que impulsó la medida de Discord. Cualquier persona que administre un servidor de Matrix con registro abierto sigue sujeta a las leyes de su jurisdicción. **La descentralización no es sinónimo de impunidad — es solo otro modelo de cumplimiento.**
