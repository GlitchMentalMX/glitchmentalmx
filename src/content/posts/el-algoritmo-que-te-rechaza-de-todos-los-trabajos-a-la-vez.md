...
---
Si alguna vez has sentido que tu currículum desaparece en un agujero negro digital después de aplicar a un trabajo, no estás alucinando. Detrás de ese silencio incómodo no siempre hay un humano perezoso; ahora hay un **ejército de Inteligencia Artificial** entrenado para decir "no" por ti. Pero el problema no es que la IA filtre, sino _cómo_ lo está haciendo. Estamos ante el dilema de los algoritmos de "baja calidad".
...
El _mindset_ de la Gen Z está cambiando, y la IA no está captándolo. La flexibilidad, el trabajo remoto, los proyectos paralelos y el _gigs economy_ son el pan de cada día, pero los sistemas de EAC están diseñados para un modelo de empleo corporativo de los 90s. La IA te está rechazando por ser un trabajador moderno.
