...
Anthropic describe al modelo como _"actualmente muy por delante de cualquier otro modelo de IA en capacidades cibernéticas"_, y advierte que anticipa una oleada de exploits automatizados que superarán la capacidad defensiva de los sistemas actuales. Por eso, el plan de lanzamiento prioriza a organizaciones defensivas: darles ventaja antes de que el modelo esté disponible para actores con otras intenciones.
