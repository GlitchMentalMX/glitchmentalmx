...
Según reportó TechCrunch, el modelo utiliza una técnica de _reinforcement learning_ (aprendizaje por refuerzo) altamente optimizada que le permite aprender a razonar paso a paso sin necesitar cantidades masivas de datos supervisados inicialmente. Esta eficiencia algorítmica es lo que le permite competir con modelos que costaron entre 10 y 20 veces más en su desarrollo.
