...
![Bluesky desaceleración: gráfica digital ascendente que se fragmenta frente a laptop con métricas sociales](/images/posts/bluesky-en-2026-crecio-por-enojo-no-por-conviccion/1.png)

  

En su _roadmap_ de producto publicado hace más de seis meses, Bluesky anunció tres mejoras que prometían elevar la experiencia: un nuevo sistema de mensajería directa, feeds personalizados mejorados y nuevas herramientas de seguridad contra el acoso. A principios de marzo de 2026, ninguna de las tres se ha materializado.
