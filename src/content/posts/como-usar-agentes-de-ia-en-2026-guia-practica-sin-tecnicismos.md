...
_"Este descubrimiento permitirá crear **[modelos más eficientes](/articulos/investigacion-revela-que-la-ia-podria-no-necesitar-datos-masivos/)** que cualquier usuario podrá ejecutar sin gran infraestructura."_
...
**Varias plataformas ofrecen agentes de IA listos para usar**: **AutoGPT**: Una de las primeras plataformas de agentes. Gratis y de código abierto. Requiere configuración técnica moderada. Buena para experimentar. **ChatGPT** **con modo agente (OpenAI)**: La opción más accesible hoy. Disponible para suscriptores Plus y Pro. Ejecuta tareas en el navegador de forma autónoma.
...
**Paso 1**: Ve a chatgpt.com e inicia sesión. Necesitas plan Plus o Pro ($20/mes).

**Paso 2**: En el selector de modelos, elige ChatGPT con herramientas o activa el modo agente desde la barra de conversación.

**Paso 3**: Define tu objetivo con claridad. Ejemplo: "Genera una lista de los 10 podcasts más populares sobre inteligencia artificial en español, con descripción de cada uno y enlace."

**Paso 4**: El agente descompondrá la tarea automáticamente: buscar, filtrar, evaluar y compilar. Verás el progreso en tiempo real.

**Paso 5**: Revisa el resultado. Si algo no está bien, dale retroalimentación específica — el agente ajustará sin que tengas que empezar de cero.

**Paso 6**: Guarda el prompt que funcionó. Los buenos objetivos para agentes son reutilizables.
