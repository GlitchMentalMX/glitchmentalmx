...
heroImage: >-
  /images/posts/honor-robot-phone-el-celular-que-baila-sigue-y-se-mueve-solo/hero.png
heroImageAlt: >-
  HONOR Robot Phone: smartphone con cámara robótica y patas mecánicas en entorno
  de seguimiento de personas
---
...
El Robot Phone no es un producto aislado. En el mismo evento, HONOR presentó su primer robot humanoide, pensado para asistencia en compras, inspecciones laborales y compañía. La empresa lo denomina su _ALPHA PLAN_, una hoja de ruta que integra el teléfono inteligente, una tienda de IA (Alpha Store) y un laboratorio de desarrollo (Alpha Lab) como tres pilares de lo que llaman "una civilización silicio-carbono".
