...
La ampliación de Mayakan a 567 MMcf/d y las nuevas plantas de ciclo combinado no eliminan la dependencia de un punto único: la trasladan a una fecha posterior y a una capacidad mayor, pero siguen dejando a la Península entera colgada de **un solo ducto y un solo corredor de transmisión**. Es un mecanismo distinto al que enfrenta [Guadalajara](/articulos/guadalajara-es-un-hub-digital-que-cfe-no-puede-alimentar/), donde el problema es que la generación no alcanza el ritmo de la demanda, o al del [Estado de México](/articulos/estado-de-mexico-la-fila-invisible-que-decide-la-nube/), donde lo que traba el paso es la fila de estudios de interconexión. En Yucatán no falta demanda ni fila: falta redundancia.
