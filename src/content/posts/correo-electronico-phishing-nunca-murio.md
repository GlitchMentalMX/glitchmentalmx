...
El total de pérdidas por cibercrimen reportadas al IC3 en 2025 alcanzó 20,877 millones de dólares, un incremento del 26% respecto al año anterior, según el mismo reporte. Dentro de ese total, **la inteligencia artificial ya deja huella medible**: el FBI registró 22,364 quejas con un componente de IA identificado, con pérdidas ajustadas de 893 millones de dólares, aunque el propio organismo advierte que la cifra real es casi con certeza mayor, porque muchas víctimas no llegan a saber que la IA estuvo involucrada en el fraude que sufrieron. Del total de pérdidas por BEC, el IC3 atribuye directamente 30 millones de dólares a casos con un componente de IA confirmado: generadores de texto que redactan correos corporativos sin errores gramaticales ni de tono, y clonación de voz —<a href="https://glitchmental.com/articulos/tu-voz-ya-no-es-tuya-biometria-banca-rota/">el mismo mecanismo de suplantación aplicado a la voz</a>— para reforzar la instrucción de pago por teléfono.

![Phishing: mujer duda entre sobres idénticos en casillero de correo sin cerradura de verificación](/images/uploads/Phishing%20Sec.webp)
