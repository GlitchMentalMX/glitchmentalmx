---
title: 'OpenAI, Google y Anthropic: aliados contra China en la IA'
...
La _destilación adversarial_ es la práctica de consultar masivamente a un modelo de IA de frontera — como Claude o GPT — y usar esas respuestas como datos de entrenamiento para construir un modelo más barato que imita sus capacidades. No se roban los pesos del modelo, que son inaccesibles. Se roba el comportamiento del modelo a través de millones de preguntas diseñadas para extraer patrones de razonamiento, conocimiento especializado y cadenas de respuesta.
