...
No es un argumento conspirativo. Es el modelo de negocio documentado de cualquier plataforma que usa _reinforcement learning from human feedback_ (RLHF), la técnica mediante la cual los modelos de lenguaje aprenden a producir respuestas más útiles a partir de las evaluaciones humanas. Los usuarios que iteran prompts, corrigen salidas y refinan resultados están haciendo, técnicamente, trabajo de anotación de datos. El mismo trabajo que empresas como Scale AI cobran entre 10 y 40 dólares por hora cuando se hace de forma explícita y contratada.
