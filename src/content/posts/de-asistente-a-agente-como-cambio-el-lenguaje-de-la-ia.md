...
---
Hace tres años, las IAs se llamaban asistentes. Hoy se llaman agentes. El cambio de una palabra no es cosmético: **define quién tiene el control, quién lleva la iniciativa y quién se lleva el crédito cuando algo sale mal**. Desempacar esa diferencia semántica es desempacar uno de los debates más importantes sobre el poder en la era de la inteligencia artificial.

## Qué significa técnicamente "agente" y de dónde viene el término

En la literatura académica de inteligencia artificial, un agente es un sistema que _percibe su entorno, razona sobre él y actúa en consecuencia_. La definición tiene décadas. Lo que cambió no es el concepto — es que ahora se aplica a modelos de lenguaje que antes nadie hubiera descrito así.
...
Pero aquí está la verdad incómoda: la mayor parte de lo que la industria llama "agentes" en 2025 y 2026 no cumple esa definición estricta. SDxCentral documentó en enero de 2026 lo que varios analistas llamaron _agent washing_: la práctica de reetiquear scripts de automatización existentes, chatbots y herramientas de proceso robótico como "agentes" sin que haya verdadera autonomía, límites de decisión ni responsabilidad. [Gartner](https://www.gartner.com/en) proyecta que más del 40% de los proyectos de IA agéntica serán cancelados antes de finales de 2027.
...
![De “asistente” a “agente”: interfaz física con botón activado en superficie minimalista de control](/images/posts/de-asistente-a-agente-como-cambio-el-lenguaje-de-la-ia/1.png)

## Qué intereses sirve el cambio de lenguaje
...
[→ Qué significa "entender" para un modelo de lenguaje](/articulos/que-significa-entender-para-un-modelo-de-lenguaje/) [→ IA que sustituye vs IA que amplifica: dos relatos](/articulos/ia-que-sustituye-vs-ia-que-amplifica-dos-relatos-un-negocio/) [→ Qué hace autónomo a un sistema](/articulos/que-hace-autonomo-a-un-sistema-mas-alla-del-robot/)
