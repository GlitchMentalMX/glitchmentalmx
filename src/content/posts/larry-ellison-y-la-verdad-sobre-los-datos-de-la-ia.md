...
description: >-
  ...
  todos…
heroImage: /images/posts/larry-ellison-y-la-verdad-sobre-los-datos-de-la-ia/hero.webp
heroImageAlt: >-
  Larry Ellison datos IA: mujer anotando en rojo documento con tablas de datos
  junto a segunda fuente sobre mesa de trabajo
---
...
Durante la llamada de resultados del segundo trimestre fiscal 2026 de Oracle, en enero de 2026, Ellison fue contundente: "Todos los grandes modelos de lenguaje se entrenan con los mismos datos. Por eso son básicamente iguales y se están comoditizando tan rápido en el mercado actual." Su argumento incluyó explícitamente a ChatGPT, Gemini, Grok y Llama como ejemplos de esa comoditización. La idea central es que el conocimiento base proviene de grandes volúmenes de contenido abierto, lo que implicaría que la ventaja competitiva ya no está en el acceso al texto público, sino en el acceso a los datos privados y empresariales.
