...
**La arquitectura de las plataformas está construida para el reenganche.** Los sistemas de notificaciones, las actualizaciones de contenido en tiempo real, los indicadores de "me gusta" diferidos — todo está calibrado para generar un estado de incertidumbre variable que mantiene al usuario revisando. Nir Eyal lo documentó con precisión en su libro _Hooked_: el modelo de negocio de estas plataformas depende de crear hábitos, no de satisfacer necesidades. Un mes de abstinencia no borra ese diseño.
