...
Lo que hace que este programa destaque en el ecosistema de 2026 es su apertura a perfiles no técnicos. OpenAI busca expertos en ciencias sociales y ciberseguridad para abordar los dilemas éticos y técnicos que sus propios ingenieros, quizás demasiado inmersos en la optimización de parámetros, han pasado por alto. Los _fellows_ seleccionados contarán con mentoría directa del equipo de OpenAI, además de acceso a recursos de cómputo y créditos de API, herramientas esenciales para auditar modelos de lenguaje de gran escala.

> Pagar a externos para encontrar las fallas de tu propio sistema no es un acto de generosidad académica; es una estrategia de transferencia de responsabilidad disfrazada de beca.
...
En la práctica, eso significa monitorear, limitar y corregir en tiempo real las acciones de un agente que tiene autonomía para interactuar con sistemas externos — no moderar lo que dice, sino lo que hace. La diferencia frente a la moderación de contenido tradicional es el tipo de daño que se intenta prevenir: no es una respuesta ofensiva, es una transferencia bancaria mal ejecutada, un archivo borrado o un sistema físico operado de forma incorrecta.
