...
El término tiene nombre propio en la regulación anglosajona: _authorised push payment fraud_, o **fraude por pago autorizado**. De acuerdo con la definición del Payment Systems Regulator del Reino Unido, se trata de una operación que el titular ordena voluntariamente después de ser engañado sobre quién recibe el dinero o sobre para qué sirve ese pago. No hay sesión secuestrada ni credenciales robadas: hay una persona convencida.
...
Léelo otra vez con el vocabulario de la serie encima. El disparador de la reversión es el verbo _autorizar_. Y autorizar es exactamente lo que el fraude moderno consigue: no rompe la autenticación, [la atraviesa con el consentimiento del titular](/articulos/correo-electronico-phishing-nunca-murio/). **El fraude no venció a la protección financiera: cumplió su definición de exclusión.**
...
![Fraude bancario autorizado: una trampa se activa al confirmar una operación y desplaza la responsabilidad al usuario](/images/uploads/fraude-bancario-autorizado-sec.webp)
...
Los cinco artículos anteriores describieron arquitecturas incompatibles entre sí con un mismo producto final. **El correo que** [**nunca verificó identidad**](/articulos/correo-electronico-phishing-nunca-murio/) **obtiene una instrucción de pago voluntaria.** [La industria que opera del otro lado](/articulos/granja-cerdos-digital-trata-fraude/) construye meses de relación para que la transferencia parezca una decisión propia. [El proceso de contratación convertido en puerta de entrada](/articulos/empleado-que-nunca-existio-corea-del-norte-empresa/) mueve nómina legítima hacia un destinatario ilegítimo. Y [cuando la voz deja de ser una credencial confiable](/articulos/tu-voz-ya-no-es-tuya-biometria-banca-rota/), la autenticación que valida la operación deja de probar quién estaba del otro lado.

**Cinco puertas distintas que desembocan en el mismo pasillo: una operación que el sistema clasifica como tuya.** Es el mismo patrón que aparece [cuando desaparece el árbitro](/articulos/datos-abiertos-el-poder-publico-que-nadie-te-explica/) en cualquier ecosistema informativo: la regla sigue existiendo, pero ya no describe el terreno que pretendía cubrir.
