...
> Las plataformas toman cocaína conductual y la esparcen sobre toda la interfaz. Eso es lo que te hace volver una y otra vez. _— Aza Raskin, inventor del scroll infinito_
...
![Dopamina y diseño: dedo presionando interfaz digital conectada a red neuronal simulada](/images/posts/dopamina-y-diseno-por-que-las-apps-son-adictivas/1.png)

  

La exposición repetida a este sistema no es neutral para la neurología. Investigación publicada en _Frontiers in Human Neuroscience_ en 2024 encontró que las personas con mayor consumo de videos de formato corto mostraban **menor actividad de ondas theta en la corteza prefrontal**, la región responsable del control de impulsos, la planificación y el foco sostenido. No es que el usuario elija no concentrarse: la estructura misma del cerebro que regula esa elección se ve afectada.
...
[→ Ansiedad digital: qué le hacen las notificaciones al cerebro](/articulos/ansiedad-digital-que-le-hacen-las-notificaciones-al-cerebro/) [→ Tu atención ya no te pertenece: la fragmentación digital](/articulos/tu-atencion-ya-no-te-pertenece-la-fragmentacion-digital/) [→ Economía de la atención: quién compite por tu tiempo](/articulos/economia-de-la-atencion-quien-compite-por-tu-tiempo/)
