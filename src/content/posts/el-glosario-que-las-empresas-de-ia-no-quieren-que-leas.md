...
description: >-
  "Inteligente", "autónomo", "razona". Las empresas de IA usan estas palabras
  con un propósito. Aquí lo que realmente significan.
...
![El glosario: bolsa flexible revela objeto interno oculto como metáfora de significado encapsulado](/images/posts/el-glosario-que-las-empresas-de-ia-no-quieren-que-leas/1.png)

  

## El caso del "agente washing" como síntoma sistémico

El ejemplo más documentado de este problema en 2025 y 2026 es el _agent washing_. SDxCentral recogió el análisis de múltiples ejecutivos de la industria que describieron el fenómeno con precisión: **en 2025, se observó un "agent washing" masivo: scripts de automatización existentes y asistentes fueron reetiquetados como 'agentes' sin verdadera autonomía, límites de decisión ni responsabilidad**.
