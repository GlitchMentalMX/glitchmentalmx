...
El creador de OpenClaw, Peter Steinberger, se incorporó recientemente a OpenAI — el rival directo de Anthropic. Poco después de ese fichaje, Anthropic aceleró las restricciones técnicas sobre la integración de Claude con herramientas externas. Steinberger fue directo en X: _"Primero copian las funciones más populares en su propio sistema cerrado y luego bloquean las alternativas de código abierto."_
