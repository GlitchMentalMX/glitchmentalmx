...
La tendencia a antropomorfizar sistemas computacionales fue documentada por Clifford Nass y Byron Reeves en The Media Equation (Stanford, 1996), donde demostraron que las personas aplican reglas sociales a computadoras incluso cuando saben que no son humanas. Con los LLMs, ese efecto se intensifica porque la interfaz es conversacional y la respuesta parece contextual.
...
**La versión científica** pregunta qué procesos ocurren realmente dentro de estos modelos. La interpretabilidad mecánica —_mechanistic interpretability_, la disciplina que intenta entender qué hacen las redes neuronales por dentro— ha encontrado que los modelos construyen representaciones internas del mundo que son más ricas de lo que sugiere la descripción simple de "predicción de siguiente token". Pero "representación interna del mundo" no es lo mismo que comprensión consciente, y **la distancia entre esos dos conceptos sigue siendo técnicamente inmensurable**.

Investigadores como Chris Olah (ex-Anthropic, ahora en su propio laboratorio de interpretabilidad) han documentado que los modelos construyen representaciones lineales de conceptos como tiempo, espacio y relaciones semánticas en su espacio latente — lo que sugiere algo más que predicción superficial. El debate es si esas representaciones constituyen comprensión o son una forma más sofisticada del mismo mecanismo estadístico.
