...
Existen sitios de cupones y hasta revendedores que anuncian códigos de 15%, 30% o 45% para Copilot, algunos dirigidos a licencias empresariales por volumen. Ninguno de esos códigos aparece confirmado en las páginas oficiales de consumidor de Microsoft, y el descuento real y verificable para una persona individual es el de estudiante: 50% con verificación, no un código que circule libremente.
