...
Hay sitios agregadores que anuncian cupones de v0 con porcentajes altos ("hasta 70% off") o supuestos créditos de miles de dólares por "alianzas exclusivas". Ninguno de esos códigos aparece mencionado en v0.app/pricing ni en la documentación oficial de Vercel, y el checkout de v0 no tiene un campo genérico para canjearlos. Si un sitio te ofrece un "código v0" universal, no viene de Vercel.
